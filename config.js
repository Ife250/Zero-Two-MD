...
global.ytname = "YT: kingsley"
global.location = "South Africa, Malawi, cavalry"
global.botscript = "https://github.com/ife250/Zero-Two-Md"
...
//═══════[modification]════════\\
global.owner = process.env.owner || ['265889976968','','' , '' , ''] //owner number, u can put multiple owner number, within quotations and seperated by comma.
...
global.botnma = process.env.botnma || 'kingsley-bot'//bot name
global.watermark = "ENJOY WITH KINGSLEY BOT"
global.dogeemoji = "✨"
global.botname = process.env.botnamw || 'kingsley-bot'
global.ownernma = 'Kíñgsléy' //owner name
global.ownername = process.env.ownername || 'Kíñgsléy' //owner name
global.packname = process.env.SPACK_NAME || 'kingsley-bot' //sticker package name
global.author = process.env.SPACK_AUTHOR || 'Dont Steal 💛 kingsley' //sticker author name
global.sessionName = process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID
global.zerotwo = "https://github.com/ife250/Zero-Two-MD" //ur gc link
global.zerotwo2 = "https://github.com/ife250/Zero-Two-MD" //ur gc link2
